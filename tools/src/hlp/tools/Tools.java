...
public final class Tools{
    ...
    public static void main(String[] args){
        ...
        meta = new ModMeta(){{name = "hlp";}};
        mod = new LoadedMod(null, null, hlp, Tools.class.getClassLoader(), meta);

        Reflect.<Seq<LoadedMod>>get(Mods.class, mods, "mods").add(mod);
        Reflect.<ObjectMap<Class<?>, ModMeta>>get(Mods.class, mods, "metas").put(HLP.class, meta);
